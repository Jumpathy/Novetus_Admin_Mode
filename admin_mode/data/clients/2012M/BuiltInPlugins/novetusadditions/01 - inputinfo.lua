...
toolbar = self:CreateToolbar("Novetus Additions")
toolbarbutton = toolbar:CreateButton("", "Input Info (Early 2012): Check coordinates of where you click and see input events triggered.", "inputinfo.png")
